# COMPLETE QIIME2 PIPELINE FOR BISECT 16S STUDY ###

# I ran fastQC on the RawData from illumina
./fastqc -o /Users/sw17073/Desktop/16S_metagenomics/01_FastQC /Users/sw17073/Desktop/16S_metagenomics/00_Rawdata/*/*

# Activate the qiime conda enviroment
...
# This is an old metadata file for the purpose of matching with Qiime2
qiime taxa barplot \
...
# Export Qiime data ready for analysis in phyloseq
qiime tools export --input-path SMP-truncr-172-truncf-279-trim10-DADA2_table.qza --output-path Exported_Files
qiime tools export --input-path SMP-truncr-172-truncf-279-trim10-DADA2_table.qza --output-path Exported_Files
qiime tools export --input-path SMP-truncr-172-truncf-279-trim10-DADA2_table.qza --output-path Exported_Files
qiime tools export --input-path SMP-truncr-172-truncf-279-trim10-DADA2_table.qza --output-path Exported_Files
